// AUTO-GENERATED from R99.yaml. Do not edit by hand.
...
export interface Cert_R99 {
  ...
  /**
   * Tests mandated by R99 type evaluation.
   */
...
/**
 * Preserved structured tables (e.g. gas range tables).
 */
