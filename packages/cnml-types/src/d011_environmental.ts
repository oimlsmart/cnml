// AUTO-GENERATED from _modules/d011_environmental.yaml. Do not edit by hand.
// Run `pnpm gen:types` to regenerate.

export type d011Environmental = unknown;

/**
 * D 11 §7.2 table 1 — climatic environment class.
 */
export type ClimaticClass = {
  "value"?: ("H1" | "H2" | "H3");
...
/**
 * D 11 §7.3 table 2 — mechanical environment class.
 */
...
/**
 * D 11 §7.4 table 3 — electromagnetic environment class.
 */
export type EMClass = {
  "value"?: ("E1" | "E2" | "E3");
  "unit"?: (unknown | unknown | (unknown | null));
...
/**
 * Ambient operating temperature range, structured with unit.
 */
...
/**
 * D 11 §3.19 / §5.3.1 — checking facility type.
 */
export type CheckingFacilityType = ("P" | "I" | "N");

/**
 * D 11 §7 test level index (1-5).
 */
export type TestLevelIndex = number;

/**
 * Reference to a D 11 performance test with optional level and notes.
 */
