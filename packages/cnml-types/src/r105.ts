// AUTO-GENERATED from R105.yaml. Do not edit by hand.
// Run `pnpm gen:types` to regenerate.

/**
 * OIML R105 "Direct mass flow measurement — Coriolis meters". Covers direct mass
...
export interface Cert_R105 {
  ...
  /**
   * Tests mandated by R105 type evaluation.
   */
...
/**
 * OIML R105-1:1993 §3.2 direct mass flow meter accuracy class.
...
/**
 * Preserved structured tables (e.g. flow-spec matrices).
 */
